...
<body>
    @yield('content')
    <div class="modal fade" id="AddPessoa" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form class="modal-body" method="POST" action="{{ url('/addPessoa') }}">
                    @csrf
    ...
    <div class="modal fade" id="editPessoa" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <form class="modal-body" method="POST" action="{{ url('/editPessoa/') }}">
                    @csrf
                    <div class="form-group">
                        <label>Nome</label>
                        <input type="text" class="form-control" name="nome" placeholder="Nome" required>
